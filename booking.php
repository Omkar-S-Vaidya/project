...
<!-- <?php
	try{
		...
		if($_SERVER["REQUEST_METHOD" ] == "POST")
		{
			...
			$from=$_POST['from'];
			$to = $_POST['to'];
			$query = "insert into book (from, to) values ('$from','$to')";
                    ...
                    <div class="left-side">
                        ...
                        <div class="tabs-content">
                            ...
                            <ul class="social-links">
                                ...
                                <li><a href="http://twitter.com">Follow our <em>Twitter</em><i class="fa fa-twitter"></i></a></li>
                        ...
                        <div id="tab1">
                            <div class="submit-form">
                                <h4>Check availability for <em>direction</em>:</h4>
                                    ...
                                    <div class="row">
										<form id="submit" method="post" action="manage.php">
                                        <div class="col-md-6">
                                            <fieldset>
                                                <label for="from">From:</label>
											
                                                <select  name='from' onchange='this.form.()' required="">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <select  name='to' onchange='this.form.()' required="">
												 <option value="">Select a location...</option>                                          
                                                    <option value="Kolhapur">Kolhapur</option>
                                                    <option value="Mumbai">Mumbai</option>                                                 
                                                    <option value="Pune">Pune</option>
                                        ...
                                        <div class="col-md-12">																			
                                            <fieldset>
												<br><br>
                                               <button type="submit" id="submit" class="btn" name="submit">Order Ticket Now</button>
                                            </fieldset>										
                                        </div>
										</form>
                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        ...
                                                        <ul class="time-weather">
                                                            ...
                                                            <li>12PM <span>18&deg;</span></li>
                                                            <li>6PM <span>14&deg;</span></li>
    ...
    <section id="most-visited">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h2>Most Visited Places by bus</h2>
                    </div>
                </div>
                <div class="col-md-12">
                    <div id="owl-mostvisited" class="owl-carousel owl-theme">
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="img/pune.png" alt="" height="300" width="500">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="img/kolaphur.png" alt="" height="300" width="500">
                                <div class="text-content">
                                    <h4>Kolaphur City</h4>
                                    <span>Kolaphur</span>
                                </div>
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="img/ahmednagar.png" alt="" height="300" width="500">
                                <div class="text-content">
                                    <h4>Ahmednagar City</h4>
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">  
							<img src="img/mumbai.png" alt="" height="300" width="500">
                                <div class="text-content">
                                    <h4>Mumbai City</h4>
                                    <span>Mumbai</span>
                                </div>
